...
本文是 `Qwen3.5-27B` 的专项部署入口，统一遵循 [README.md](README.md) 的当前口径：
...
推荐直接使用 [docs/examples/qwen35-27b/docker-compose.qwen35-27b.yml](docs/examples/qwen35-27b/docker-compose.qwen35-27b.yml) 模板。
...
推荐直接使用 [docs/examples/qwen35-27b/qwen35-27b.yaml](docs/examples/qwen35-27b/qwen35-27b.yaml) 模板，并按实际集群替换镜像、模型卷、GPU/NPU 资源名和调度规则。
...
Worker 节点只需要替换 `RANK_IP`，其余拓扑环境变量保持一致：
