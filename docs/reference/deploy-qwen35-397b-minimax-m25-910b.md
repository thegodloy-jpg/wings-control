...
> 状态：历史专项分析。当前正式部署形态只按 Docker Compose 和 K8s 编排组织；部署入口请优先阅读 [../../README.md](../../README.md)、[../deployment/docker-compose.md](../deployment/docker-compose.md)、[../deployment/k8s.md](../deployment/k8s.md) 和 [../compatibility.md](../compatibility.md)。本文仅用于容量估算、模型约束和历史决策追溯。
