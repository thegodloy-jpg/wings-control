...
> 状态：历史测试要求参考。当前产品边界、部署形态和特性入口请以 [../product-overview.md](../product-overview.md)、[../deployment/docker-compose.md](../deployment/docker-compose.md)、[../deployment/k8s.md](../deployment/k8s.md) 和 [../features/index.md](../features/index.md) 为准。
