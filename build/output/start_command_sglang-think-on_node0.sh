...
ANALYZER_CONFIG='{"engine": "sglang", "deployment_mode": "single", "hardware": "nvidia", "nnodes": 1, "node_rank": 0, "distributed_backend": "mp", "tensor_parallel_size": 8, "model_name": "Qwen3.6-27B", "model_path": "D:/project/inference/wings-control/wings-control-0730/wings-control/build/model_osmvu8lj", "backend_port": 17000}'
...
echo '[wings-cmd] >>> exec python3 -m sglang.launch_server --trust-remote-code --context-length 5120 --tool-call-parser qwen --host 192.168.1.100 --port 17000 --served-model-name Qwen3.6-27B --model-path D:/project/inference/wings-control/wings-control-0730/wings-control/build/model_osmvu8lj --dtype auto --kv-cache-dtype auto --mem-fraction-static 0.9 --chunked-prefill-size 4096 --max-running-requests 32 --random-seed 0 --disable-chunked-prefix-cache --tp-size 8'
