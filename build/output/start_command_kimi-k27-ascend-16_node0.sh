...
ANALYZER_CONFIG='{"engine": "vllm_ascend", "deployment_mode": "single", "hardware": "ascend", "nnodes": 1, "node_rank": 0, "distributed_backend": "dp_deployment", "tensor_parallel_size": 16, "model_name": "Kimi-K2.7-Code", "model_path": "D:/project/inference/wings-control/wings-control-0730/wings-control/build/model_wv2wbugk", "backend_port": 17000}'
...
echo '[wings-cmd] >>> exec python3 -m vllm.entrypoints.openai.api_server --trust-remote-code --max-model-len 4096 --max-num-seqs 16 --max-num-batched-tokens 16384 --gpu-memory-utilization 0.9 --no-enable-prefix-caching --enable-auto-tool-choice --tool-call-parser kimi_k2 --async-scheduling --compilation-config '"'"'{"cudagraph_capture_sizes":[4,8,16,32,64,128,256],"cudagraph_mode":"FULL_DECODE_ONLY"}'"'"' --mm-encoder-tp-mode data --allowed-local-media-path / --host 192.168.1.100 --port 17000 --served-model-name Kimi-K2.7-Code --model D:/project/inference/wings-control/wings-control-0730/wings-control/build/model_wv2wbugk --dtype auto --kv-cache-dtype auto --block-size 16 --seed 0 --enable-expert-parallel --default-chat-template-kwargs '"'"'{"thinking":false}'"'"' --tensor-parallel-size 16'
python3 -m vllm.entrypoints.openai.api_server --trust-remote-code --max-model-len 4096 --max-num-seqs 16 --max-num-batched-tokens 16384 --gpu-memory-utilization 0.9 --no-enable-prefix-caching --enable-auto-tool-choice --tool-call-parser kimi_k2 --async-scheduling --compilation-config '{"cudagraph_capture_sizes":[4,8,16,32,64,128,256],"cudagraph_mode":"FULL_DECODE_ONLY"}' --mm-encoder-tp-mode data --allowed-local-media-path / --host 192.168.1.100 --port 17000 --served-model-name Kimi-K2.7-Code --model D:/project/inference/wings-control/wings-control-0730/wings-control/build/model_wv2wbugk --dtype auto --kv-cache-dtype auto --block-size 16 --seed 0 --enable-expert-parallel --default-chat-template-kwargs '{"thinking":false}' --tensor-parallel-size 16 &
ENGINE_PID=$!
