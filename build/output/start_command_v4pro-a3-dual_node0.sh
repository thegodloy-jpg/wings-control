...
echo '[wings-cmd] >>> exec vllm serve D:/project/inference/wings-control/wings-control-0730/wings-control/build/model_2hice2w_ --trust-remote-code --max-model-len 135000 --max-num-batched-tokens 4096 --gpu-memory-utilization 0.9 --max-num-seqs 16 --tensor-parallel-size 16 --enable-expert-parallel --quantization ascend --block-size 128 --async-scheduling --safetensors-load-strategy prefetch --compilation-config '"'"'{"cudagraph_mode":"FULL_DECODE_ONLY"}'"'"' --additional-config '"'"'{"enable_cpu_binding":true,"ascend_compilation_config":{"enable_npugraph_ex":true,"enable_static_kernel":false}}'"'"' --tokenizer-mode deepseek_v4 --tool-call-parser deepseek_v4 --enable-auto-tool-choice --host 192.168.1.100 --port 17000 --served-model-name DeepSeek-V4-Pro --dtype auto --kv-cache-dtype auto --seed 0 --default-chat-template-kwargs '"'"'{...<truncated>'
vllm serve D:/project/inference/wings-control/wings-control-0730/wings-control/build/model_2hice2w_ --trust-remote-code --max-model-len 135000 --max-num-batched-tokens 4096 --gpu-memory-utilization 0.9 --max-num-seqs 16 --tensor-parallel-size 16 --enable-expert-parallel --quantization ascend --block-size 128 --async-scheduling --safetensors-load-strategy prefetch --compilation-config '{"cudagraph_mode":"FULL_DECODE_ONLY"}' --additional-config '{"enable_cpu_binding":true,"ascend_compilation_config":{"enable_npugraph_ex":true,"enable_static_kernel":false}}' --tokenizer-mode deepseek_v4 --tool-call-parser deepseek_v4 --enable-auto-tool-choice --host 192.168.1.100 --port 17000 --served-model-name DeepSeek-V4-Pro --dtype auto --kv-cache-dtype auto --seed 0 --default-chat-template-kwargs '{"thinking":false}' --data-parallel-address 192.168.1.100 --data-parallel-rpc-port 13399 --data-parallel-size 2 --data-parallel-size-local 1 --data-parallel-start-rank 0 &
ENGINE_PID=$!
