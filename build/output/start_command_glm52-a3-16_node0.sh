...
ANALYZER_CONFIG='{"engine": "vllm_ascend", "deployment_mode": "single", "hardware": "ascend", "nnodes": 1, "node_rank": 0, "distributed_backend": "dp_deployment", "tensor_parallel_size": 16, "model_name": "GLM-5.2-355B-A3B-W8A8-Chat", "model_path": "D:/project/inference/wings-control/wings-control-0730/wings-control/build/model_paxe4chx", "backend_port": 17000}'
