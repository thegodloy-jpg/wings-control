...
ANALYZER_CONFIG='{"engine": "vllm_ascend", "deployment_mode": "single", "hardware": "ascend", "nnodes": 1, "node_rank": 0, "distributed_backend": "ray", "tensor_parallel_size": 16, "model_name": "GLM-5.2-w8a8", "model_path": "D:/project/inference/wings-control/wings-control-0730/wings-control/build/model_n6uws3y2", "backend_port": 17000}'
...
echo '[wings-cmd] >>> exec python3 -m vllm.entrypoints.openai.api_server --trust-remote-code --max-model-len 81920 --quantization ascend --seed 1024 --max-num-seqs 16 --max-num-batched-tokens 4096 --gpu-memory-utilization 0.98 --enable-expert-parallel --async-scheduling --additional-config '"'"'{"fuse_muls_add":true,"multistream_overlap_shared_expert":true,"ascend_compilation_config":{"enable_npugraph_ex":true}}'"'"' --compilation-config '"'"'{"cudagraph_mode":"FULL_DECODE_ONLY"}'"'"' --host 192.168.1.100 --port 17000 --served-model-name GLM-5.2-w8a8 --model D:/project/inference/wings-control/wings-control-0730/wings-control/build/model_n6uws3y2 --dtype auto --kv-cache-dtype auto --block-size 16 --default-chat-template-kwargs '"'"'{"enable_thinking":false}'"'"' --tensor-parallel-size 16 --speculative-config '"'"'{"method": "deepseek_mtp",...<truncated>'
python3 -m vllm.entrypoints.openai.api_server --trust-remote-code --max-model-len 81920 --quantization ascend --seed 1024 --max-num-seqs 16 --max-num-batched-tokens 4096 --gpu-memory-utilization 0.98 --enable-expert-parallel --async-scheduling --additional-config '{"fuse_muls_add":true,"multistream_overlap_shared_expert":true,"ascend_compilation_config":{"enable_npugraph_ex":true}}' --compilation-config '{"cudagraph_mode":"FULL_DECODE_ONLY"}' --host 192.168.1.100 --port 17000 --served-model-name GLM-5.2-w8a8 --model D:/project/inference/wings-control/wings-control-0730/wings-control/build/model_n6uws3y2 --dtype auto --kv-cache-dtype auto --block-size 16 --default-chat-template-kwargs '{"enable_thinking":false}' --tensor-parallel-size 16 --speculative-config '{"method": "deepseek_mtp", "num_speculative_tokens": 3}' &
ENGINE_PID=$!
...
export VLLM_VERSION=0.21.0
echo "[wings-env] export VLLM_VERSION=${VLLM_VERSION:-}"
echo '[wings-cmd] >>> exec python3 -m vllm.entrypoints.openai.api_server --trust-remote-code --max-model-len 81920 --quantization ascend --seed 1024 --max-num-seqs 16 --max-num-batched-tokens 4096 --gpu-memory-utilization 0.98 --enable-expert-parallel --async-scheduling --additional-config '"'"'{"fuse_muls_add":true,"multistream_overlap_shared_expert":true,"ascend_compilation_config":{"enable_npugraph_ex":true}}'"'"' --compilation-config '"'"'{"cudagraph_mode":"FULL_DECODE_ONLY"}'"'"' --host 192.168.1.100 --port 17000 --served-model-name GLM-5.2-w8a8 --model D:/project/inference/wings-control/wings-control-0730/wings-control/build/model_n6uws3y2 --dtype auto --kv-cache-dtype auto --block-size 16 --default-chat-template-kwargs '"'"'{"enable_thinking":false}'"'"' --tensor-parallel-size 16'
python3 -m vllm.entrypoints.openai.api_server --trust-remote-code --max-model-len 81920 --quantization ascend --seed 1024 --max-num-seqs 16 --max-num-batched-tokens 4096 --gpu-memory-utilization 0.98 --enable-expert-parallel --async-scheduling --additional-config '{"fuse_muls_add":true,"multistream_overlap_shared_expert":true,"ascend_compilation_config":{"enable_npugraph_ex":true}}' --compilation-config '{"cudagraph_mode":"FULL_DECODE_ONLY"}' --host 192.168.1.100 --port 17000 --served-model-name GLM-5.2-w8a8 --model D:/project/inference/wings-control/wings-control-0730/wings-control/build/model_n6uws3y2 --dtype auto --kv-cache-dtype auto --block-size 16 --default-chat-template-kwargs '{"enable_thinking":false}' --tensor-parallel-size 16 &
ENGINE_PID=$!
