...
echo '[wings-cmd] >>> exec vllm serve D:/project/inference/wings-control/wings-control-0730/wings-control/build/model_c3_nf6wl --trust-remote-code --max-model-len 131072 --quantization ascend --seed 1024 --max-num-seqs 2 --max-num-batched-tokens 4096 --gpu-memory-utilization 0.95 --compilation-config '"'"'{"cudagraph_mode":"FULL_DECODE_ONLY"}'"'"' --host 192.168.1.100 --port 17000 --served-model-name glm-5.1-32b-chat --dtype auto --kv-cache-dtype auto --block-size 16 --enable-expert-parallel --default-chat-template-kwargs '"'"'{"enable_thinking":false}'"'"' --tensor-parallel-size 16 --enable-prefix-caching --speculative-config '"'"'{"method": "deepseek_mtp", "num_speculative_tokens": 1}'"'"' --hf-overrides '"'"'{"index_topk_freq": 8}'"'"' --data-parallel-address 192.168.1.100 --data-parallel-rpc-port 13355 --data-parallel-size 2 --data-parall...<truncated>'
vllm serve D:/project/inference/wings-control/wings-control-0730/wings-control/build/model_c3_nf6wl --trust-remote-code --max-model-len 131072 --quantization ascend --seed 1024 --max-num-seqs 2 --max-num-batched-tokens 4096 --gpu-memory-utilization 0.95 --compilation-config '{"cudagraph_mode":"FULL_DECODE_ONLY"}' --host 192.168.1.100 --port 17000 --served-model-name glm-5.1-32b-chat --dtype auto --kv-cache-dtype auto --block-size 16 --enable-expert-parallel --default-chat-template-kwargs '{"enable_thinking":false}' --tensor-parallel-size 16 --enable-prefix-caching --speculative-config '{"method": "deepseek_mtp", "num_speculative_tokens": 1}' --hf-overrides '{"index_topk_freq": 8}' --data-parallel-address 192.168.1.100 --data-parallel-rpc-port 13355 --data-parallel-size 2 --data-parallel-size-local 1 &
ENGINE_PID=$!
...
export VLLM_ENGINE_READY_TIMEOUT_S=7200
echo "[wings-env] export VLLM_ENGINE_READY_TIMEOUT_S=${VLLM_ENGINE_READY_TIMEOUT_S:-}"
echo '[wings-cmd] >>> exec vllm serve D:/project/inference/wings-control/wings-control-0730/wings-control/build/model_c3_nf6wl --trust-remote-code --max-model-len 131072 --quantization ascend --seed 1024 --max-num-seqs 2 --max-num-batched-tokens 4096 --gpu-memory-utilization 0.95 --compilation-config '"'"'{"cudagraph_mode":"FULL_DECODE_ONLY"}'"'"' --host 192.168.1.100 --port 17000 --served-model-name glm-5.1-32b-chat --dtype auto --kv-cache-dtype auto --block-size 16 --enable-expert-parallel --default-chat-template-kwargs '"'"'{"enable_thinking":false}'"'"' --tensor-parallel-size 16 --enable-prefix-caching --hf-overrides '"'"'{"index_topk_freq": 8}'"'"' --data-parallel-address 192.168.1.100 --data-parallel-rpc-port 13355 --data-parallel-size 2 --data-parallel-size-local 1'
vllm serve D:/project/inference/wings-control/wings-control-0730/wings-control/build/model_c3_nf6wl --trust-remote-code --max-model-len 131072 --quantization ascend --seed 1024 --max-num-seqs 2 --max-num-batched-tokens 4096 --gpu-memory-utilization 0.95 --compilation-config '{"cudagraph_mode":"FULL_DECODE_ONLY"}' --host 192.168.1.100 --port 17000 --served-model-name glm-5.1-32b-chat --dtype auto --kv-cache-dtype auto --block-size 16 --enable-expert-parallel --default-chat-template-kwargs '{"enable_thinking":false}' --tensor-parallel-size 16 --enable-prefix-caching --hf-overrides '{"index_topk_freq": 8}' --data-parallel-address 192.168.1.100 --data-parallel-rpc-port 13355 --data-parallel-size 2 --data-parallel-size-local 1 &
ENGINE_PID=$!
