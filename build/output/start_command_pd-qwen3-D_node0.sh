...
ANALYZER_CONFIG='{"engine": "vllm_ascend", "deployment_mode": "single", "hardware": "ascend", "nnodes": 1, "node_rank": 0, "distributed_backend": "ray", "tensor_parallel_size": 2, "model_name": "Qwen3-30B-A3B", "model_path": "D:/project/inference/wings-control/wings-control-0730/wings-control/build/model_upqthwm_", "backend_port": 17000}'
...
export HCCL_IF_IP=9.0.1.1
echo "[wings-env] export HCCL_IF_IP=${HCCL_IF_IP:-}"
export VLLM_HOST_IP=9.0.1.1
