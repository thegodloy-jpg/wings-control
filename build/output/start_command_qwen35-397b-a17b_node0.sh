...
ANALYZER_CONFIG='{"engine": "vllm_ascend", "deployment_mode": "single", "hardware": "ascend", "nnodes": 1, "node_rank": 0, "distributed_backend": "mp", "tensor_parallel_size": 16, "model_name": "Qwen3.5-397B-A17B", "model_path": "D:/project/inference/wings-control/wings-control-0730/wings-control/build/model_d5x3bmp3", "backend_port": 17000}'
...
echo '[wings-cmd] >>> exec python3 -m vllm.entrypoints.openai.api_server --trust-remote-code --max-model-len 4096 --quantization ascend --enable-expert-parallel --max-num-seqs 128 --max-num-batched-tokens 16384 --gpu-memory-utilization 0.9 --enable-prefix-caching --async-scheduling --compilation-config '"'"'{"cudagraph_mode":"FULL_DECODE_ONLY"}'"'"' --additional-config '"'"'{"enable_cpu_binding":true}'"'"' --tool-call-parser qwen3_coder --reasoning-parser qwen3 --host 192.168.1.100 --port 17000 --served-model-name Qwen3.5-397B-A17B --model D:/project/inference/wings-control/wings-control-0730/wings-control/build/model_d5x3bmp3 --dtype auto --kv-cache-dtype auto --block-size 16 --seed 0 --enable-auto-tool-choice --default-chat-template-kwargs '"'"'{"enable_thinking":true}'"'"' --tensor-parallel-size 16'
python3 -m vllm.entrypoints.openai.api_server --trust-remote-code --max-model-len 4096 --quantization ascend --enable-expert-parallel --max-num-seqs 128 --max-num-batched-tokens 16384 --gpu-memory-utilization 0.9 --enable-prefix-caching --async-scheduling --compilation-config '{"cudagraph_mode":"FULL_DECODE_ONLY"}' --additional-config '{"enable_cpu_binding":true}' --tool-call-parser qwen3_coder --reasoning-parser qwen3 --host 192.168.1.100 --port 17000 --served-model-name Qwen3.5-397B-A17B --model D:/project/inference/wings-control/wings-control-0730/wings-control/build/model_d5x3bmp3 --dtype auto --kv-cache-dtype auto --block-size 16 --seed 0 --enable-auto-tool-choice --default-chat-template-kwargs '{"enable_thinking":true}' --tensor-parallel-size 16 &
ENGINE_PID=$!
