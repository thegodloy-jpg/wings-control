...
ANALYZER_CONFIG='{"engine": "vllm_ascend", "deployment_mode": "distributed", "hardware": "ascend", "nnodes": 2, "node_rank": 0, "distributed_backend": "dp_deployment", "tensor_parallel_size": 16, "model_name": "GLM-5.2-w8a8", "model_path": "D:/project/inference/wings-control/wings-control-0730/wings-control/build/model_637mjlrr", "backend_port": 17000}'
