...
ANALYZER_CONFIG='{"engine": "sglang", "deployment_mode": "single", "hardware": "nvidia", "nnodes": 1, "node_rank": 0, "distributed_backend": "ray", "tensor_parallel_size": 4, "model_name": "Qwen3-Embedding", "model_path": "/models/Qwen3-Embedding", "backend_port": 17000}'
