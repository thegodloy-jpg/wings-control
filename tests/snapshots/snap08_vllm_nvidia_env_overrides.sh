...
ANALYZER_CONFIG='{"engine": "vllm", "deployment_mode": "single", "hardware": "nvidia", "nnodes": 1, "node_rank": 0, "distributed_backend": "ray", "tensor_parallel_size": 8, "model_name": "Llama-3-70B", "model_path": "/models/Llama-3-70B", "backend_port": 17000}'
...
echo "[wings-env] export MY_CUSTOM_VAR=${MY_CUSTOM_VAR:-}"
